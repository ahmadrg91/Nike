        ...
        <ul className="ml-4 my-10 flex w-full flex-col gap-10 rounded-2xl p-12 shadow-[0px_0px_25px_0px_rgba(0,0,0,0.1)]">
          ...
          {products.map((product, index) => (
            <li key={product.name}>
              ...
              <CartItem key={product.name} properties={{Color: capitalize(product.color), Size: product.size}} {...product} increaseQuantity={addToCart} decreaseQuantity={removeFromCart}/>
            </li>
          ))}
        </ul>
    )
