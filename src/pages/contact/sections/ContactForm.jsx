...
const ContactForm = () => {
    ...
    return (
        <div className="flex gap-24 m-24">
            ...
            <div className="flex flex-1 mt-24">
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 w-full items-center justify-start shadow-3xl pb-12 px-8 rounded-lg">
